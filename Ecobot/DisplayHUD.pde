class DisplayHud {
  ...
  void desenharHUD() {
    ...
    rect(20, 20, 200, Global.tamanhoIcone); // Contorno da barra
    fill(0, 255, 0); // Cor verde para a barra de energia
    rect(20, 20, Global.nivelBateria * 2, Global.tamanhoIcone); // Bateria proporcional à energia
    ...
    // Lixo Restante
    image(lixoIcon, 20, 50, Global.tamanhoIcone, Global.tamanhoIcone); // Ícone do lixo
    text("Lixo: " + Global.lixoMapa, 50, 65);

    // Plantas Secas
    image(plantaIcon, 150, 50, Global.tamanhoIcone, Global.tamanhoIcone); // Ícone da planta
    text("Plantas: " + Global.plantas, 180, 65);

    // Inimigos
    image(inimigoIcon, 280, 50, Global.tamanhoIcone, Global.tamanhoIcone); // Ícone do inimigo
